...
def get_binary_dataset():
    df = pd.read_csv("E:\VS Code Workspaces\Projects\Python Projects\\Neural Net\\adult+stretch.csv")
    X = df.iloc[:, :-1]
    y = df.iloc[:, -1]
...
if __name__ == '__main__':
    ...
    ann = ANN(layers_dims)
    ann.fit(train_x, train_y, learning_rate=0.05, n_iterations=10000)
